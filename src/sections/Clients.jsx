              ...
              <div className="client-content">
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col">
                    <p className="font-semibold text-white-800 flex items-center client-name">
  {item.name}

 {/* <img src="/svg/verified.webp" */}

<img src="/svg/Verifiedcheckmark.svg"

 alt="Verified" className="checkmark" />
</p>
